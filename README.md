...
Убедитесь, что папка images/ находится в корне проекта и содержит изображения.

Файлы index.html, style.css, script.js должны быть в одной папке.

Откройте файл index.html в любом современном браузере (Google Chrome, Mozilla Firefox, Safari, Edge).
